Original prompt: 开始做精修：把奖励图标位置、印刷字样、局部几何比例，逐项对照你上传的参考图去校。

- 2026-04-01: Loaded the score-sheet reference PDF and compared it with the current yellow/blue zone screenshots in `issues/`.
- 2026-04-01: Focus for this pass is reward icon placement, printed masthead wording, and local geometry ratios in the yellow/blue sections.
- 2026-04-01: Refined `ScoreSheetBoard` and `global.css` so yellow/blue reward markers sit in dedicated print-style slots, the masthead reads closer to the paper sheet, and local spacing/proportions are tighter.
